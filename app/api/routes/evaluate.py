...
from app.core.errors import TaskNotFoundError, TemplateNotFoundError
...
# In-memory task storage (in a production environment, this would be a persistent store)
